...
def index():
    if not sport_selected():
        return render_template("index35_cam_sole_V9.html", **ui_template_context("sport_select"))
...
def calibration_page():
    ...
    return render_template("index35_cam_sole_V9.html", **ui_template_context("calibration"))
...
def recording_page():
    ...
    return render_template("index35_cam_sole_V9.html", **ui_template_context("recording"))
